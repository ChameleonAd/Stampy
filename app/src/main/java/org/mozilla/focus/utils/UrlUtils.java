...
public class UrlUtils {
    ...
    //Let's modify this and add Stampy's search.stampy.app query paramater
    public static String createSearchUrl(Context context, String searchTerm) {
        ...
        //Only return Stampy's search injection from q.php and 3d level domain search
        return "https://search.stampy.app/q.php?q=" + searchTerm;
    }
