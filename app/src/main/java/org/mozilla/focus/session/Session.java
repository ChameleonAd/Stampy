...
public class Session {
    ...
    private boolean noMediaEnabled;
    ...
    /* package */ Session(Source source, String url) {
        ...
        this.isJSEnabled =
               // Boolean.getBoolean(Resources.getSystem().getString(R.string.pref_key_performance_block_javascript)) ||
                        false;
        this.isRecorded = false;
        this.noMediaEnabled = //Boolean.getBoolean(Resources.getSystem().getString(R.string.pref_key_performance_block_images)) ||
                false;
    }
    ...
    //No Media State Enabled state

    public boolean isNoMediaEnabled() {
        return noMediaEnabled;
    }

    //No Media Bool State Enabled state

    public void setNoMediaEnabled(boolean NoMediaEnabled) {
        this.noMediaEnabled = NoMediaEnabled;
    }



    //JS Bool State Enabled state
    ...
    public void setJSDisabled(boolean JsEnabled) {
