...
public class SessionManagerTest {
    ...
    public void testShareIntentWithTextViaNewIntent() {
        ...
        final String SEARCH_QUERY = "https://www.google.com/search?q=Hello%20World%20Stampy&ie=utf-8&oe=utf-8&client=firefox-b";
        final Session session = sessions.get(0);
        assertTrue(session.isSearch());
        assertEquals("Hello World Stampy", session.getSearchTerms());
